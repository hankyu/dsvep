              ...
              @if ($unit_data[$j]->u_id == $num)
                <li>
                    @if (($unit_data[$j]->c_video != '') && ($unit_data[$j]->c_video_situation == 'free'))
                        <div class="lesson-list lesson-preview-video row" onclick="_zoom_video({{ $j }}, '/media/{{ $lesson_data->l_id }}/lesson/{{ $unit_data[$j]->c_video }}')" >
                    ...
                    @else
                        <div class="lesson-list lesson-preview-text row">
